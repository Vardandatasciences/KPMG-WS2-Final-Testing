...
class UserSettings(models.Model):
    """
    User settings model for storing user preferences like theme
    """
    SettingsId = models.AutoField(primary_key=True)
    UserId = models.ForeignKey('Users', on_delete=models.CASCADE, db_column='UserId', related_name='settings')
    ...
    def __str__(self):
        return f"Settings for User {self.UserId.UserId} - Theme: {self.Theme}"
