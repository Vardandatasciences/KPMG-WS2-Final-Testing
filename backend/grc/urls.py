...
# Direct endpoint for save-checked-sections-json (backup)
    ...
    *notification_urlpatterns,
    ...
    path('user-theme/<int:user_id>/', user_profile.get_user_theme, name='get_user_theme'),
    path('user-theme/<int:user_id>/', user_profile.update_user_theme, name='update_user_theme'),
