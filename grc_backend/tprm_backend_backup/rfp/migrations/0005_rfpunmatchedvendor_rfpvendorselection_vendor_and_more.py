...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tprm_rfp', '0004_alter_rfp_rfp_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tprm_rfp.vendorcategory'),
        ),
        migrations.AddField(
            model_name='rfpvendorselection',
            name='rfp',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vendor_selections', to='tprm_rfp.rfp'),
        ),
        migrations.AddField(
            model_name='rfpvendorselection',
            name='unmatched_vendor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tprm_rfp.rfpunmatchedvendor'),
        ),
        migrations.AddField(
            model_name='rfpvendorselection',
            name='vendor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tprm_rfp.vendor'),
        ),
        migrations.AddIndex(
