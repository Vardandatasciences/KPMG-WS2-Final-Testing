...
class SystemIdentifiedRiskQueue(EncryptedFieldsMixin, models.Model):
    ...
    velocity_score = models.IntegerField(null=True, blank=True, default=3,
                                         help_text="1-5 scale of risk velocity (how quickly it could materialize)")
    functional_area = models.CharField(max_length=100, null=True, blank=True, default='IT',
                                       help_text="Functional business area or department impacted")
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['functional_area'], name='idx_sirq_func_area'),
            models.Index(fields=['velocity_score'], name='idx_sirq_velocity'),
        ]
