    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tprm_rfp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='tprm_rfp.rfp')),
                ('vendor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tprm_rfp.vendor')),
            ],
            options={
