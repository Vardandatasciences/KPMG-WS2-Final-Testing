...
export const API_ENDPOINTS = {
  ...
  FRAMEWORK_POLICIES_RECURSIVE: (frameworkId) => `${API_BASE_URL}/api/frameworks/${frameworkId}/policies-recursive/`,
...
// Jira Integration
  ...
  AUDIT_ADD_COMPLIANCE: (auditId) => `${API_BASE_URL}/api/audits/${auditId}/add-compliance/`,
  ...
  AUDIT_SAVE_REVIEW_PROGRESS: (auditId) => `${API_BASE_URL}/api/audits/${auditId}/save-review-progress/`,
  AI_AUDIT_DOCUMENTS: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/`,
  AI_AUDIT_DOCUMENT_SERVE: (auditId, docId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/${docId}/serve/`,
  AI_AUDIT_REPORT_DOWNLOAD: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/download-report/`,
  AI_AUDIT_ANNUAL_CONSOLIDATION: (auditId, year) => `${API_BASE_URL}/api/ai-audit/${auditId}/annual-consolidation/${year ? `?year=${year}` : ''}`,
  AI_AUDIT_ADD_CUSTOM_COMPLIANCE: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/add-custom-compliance/`,
  AI_AUDIT_STATUS: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/status/`,
  AI_AUDIT_START_PROCESSING: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/start-processing/`,
  AI_AUDIT_SELECTIVE_PROCESSING: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/start-selective-processing/`,
  AI_AUDIT_DOCUMENT_UPLOAD: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/upload-document/`,
  AI_AUDIT_ANALYZE_RELEVANCE: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/analyze-document-relevance/`,
  AI_AUDIT_COMPLIANCE_RESULTS: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/compliance-results/`,
  AI_AUDIT_RELEVANT_DOCS: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/relevant-documents/`,
  AI_AUDIT_SCHEDULES: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/schedules/`,
  AI_AUDIT_SCHEDULE_CREATE: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/schedule/`,
  AI_AUDIT_SCHEDULE_ACTION: (id) => `${API_BASE_URL}/api/ai-audit/schedules/${id}/`,
  AI_AUDIT_RUNS: (id) => `${API_BASE_URL}/api/ai-audit/schedules/${id}/runs/`,
  AI_AUDIT_JOB_STATUS: (jobId) => `${API_BASE_URL}/api/ai-audit/compliance-job/${jobId}/status/`,
  AI_AUDIT_DOCUMENT_CHECK: (auditId, docId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/${docId}/check/`,
  AI_AUDIT_DOCUMENT_DELETE: (auditId, docId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/${docId}/`,
  AI_AUDIT_DOCUMENT_DELETE_ALL: (auditId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/delete-all/`,
  AI_AUDIT_DOCUMENT_VIEW_URL: (auditId, docId) => `${API_BASE_URL}/api/ai-audit/${auditId}/documents/${docId}/view-url/`,
  SEBI_AUDITOR_DASHBOARD: `${API_BASE_URL}/api/sebi-auditor/dashboard/`,
  SEBI_AUDITOR_FILING_ACCURACY: (auditId) => `${API_BASE_URL}/api/sebi-auditor/audit/${auditId}/filing-accuracy/`,
  SEBI_AUDITOR_TIMELINESS_SLA: (auditId) => `${API_BASE_URL}/api/sebi-auditor/audit/${auditId}/timeliness-sla/`,
  SEBI_AUDITOR_RISK_SCORE: (auditId) => `${API_BASE_URL}/api/sebi-auditor/audit/${auditId}/risk-score/`,
  SEBI_AUDITOR_PATTERNS: `${API_BASE_URL}/api/sebi-auditor/patterns/`,
  AUDIT_MY_REVIEWS: `${API_BASE_URL}/api/my-reviews/`,
  AUDITS_PUBLIC: `${API_BASE_URL}/api/audits/public/`,
  COMPLIANCE_POLICIES_ALL: `${API_BASE_URL}/api/policies/`,
  AI_RECOMMENDATIONS: `${API_BASE_URL}/api/ai-recommendations/`,
  COMPLIANCE_MAPPING_REQUIREMENTS: (policyId) => `${API_BASE_URL}/api/compliance-mapping/requirements/${policyId}/`,
